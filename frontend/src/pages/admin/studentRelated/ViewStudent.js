        ...
        const renderTableSection = () => {
            return (
                <>
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow>
                                ...
                                <StyledTableCell>إجمالي الجلسات</StyledTableCell>
                                <StyledTableCell>نسبة الحضور</StyledTableCell>
                                <StyledTableCell align="center">أجراءات</StyledTableCell>
                            </StyledTableRow>
                        </TableHead>
                    ...
                    <Button variant="contained" color="error" startIcon={<DeleteIcon />} onClick={() => removeHandler(studentID, "RemoveStudentAtten")}>حذف الكل</Button>
    ...
    const StudentDetailsSection = () => {
        return (
            <div>
                ...
                <br />
                رقم الطالب: {userDetails.rollNum}
                <br />
                        ...
                        <TabContext value={value}>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <TabList onChange={handleChange} sx={{ position: 'fixed', width: '100%', bgcolor: 'background.paper', zIndex: 1 }}>
                                    ...
                                    <Tab label="الحضور والغياب" value="2" />
