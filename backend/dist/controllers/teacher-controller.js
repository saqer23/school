...
const getTeacherDetail = async (req, res) => {
  try {
    let teacher = await Teacher.findById(req.params.id).populate("teachSubject", "subName sessions").populate("school", "schoolName").populate("teachSclass", "sclassName");
    if (teacher) {
      teacher.password = undefined;
      res.send(teacher);
    } else {
...
const deleteTeachers = async (req, res) => {
  try {
    ...
    const deletedTeachers = await Teacher.find({
      school: req.params.id
    });
